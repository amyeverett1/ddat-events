...
<div class="container index">
  <div class="accordion">
    ...
    <h3><i class="fa fa-list-ol fa-lg" aria-hidden="true"></i> <span>DDaT Together - 24 October 2018</span></h3>
    <div>
      <div class="wrapper">
        <p>The next DDaT Together event is scheduled for 24 October 2018. Further details will be added in due course.</p>
      </div> <!-- wrapper-->
    </div><!-- end agenda-->
    ...
    <div>
      <div class="wrapper">
        <div class="box white">
          <p>The next DDaT all-staff dial-in will be held later in the year. In the meantime, if you have any questions you would like to raise with Joanna and the leadership team please use this anonymous link.</p>
        </div><!-- boxwhite-->
      </div> <!-- wrapper-->
    </div>
      ...
      <div class="wrapper">
        <div class="box white">
          ...
          <ul>
            ...
            <li>Rachelle Hembury – Generational Diversity</li>
            <li>Zuz Kopecka – Sexual Orientation and Gender Identity</li>
            <li>Sam Layne – Disability</li>
